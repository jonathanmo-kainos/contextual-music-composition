...
def generate_song(user_input_text, display_sheet_music, instrument_number,  note_certainty, note_speed):
    ...
    random_input, slider_components = utils.convert_pca_components_to_random_decoder_input(sample_type)
    if enums.EnvVars.DEBUG_MODE:
        print('Random music seed: ' + str(random_input))
    song_name = 'autoencoder 2000 ' + str(random_input[0]) + ' ' + user_input.text + ' ' + str(user_input.instrument_number)
